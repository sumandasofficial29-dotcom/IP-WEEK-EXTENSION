 ...
 */
export const FRAMEWORK_SIGNATURES: Record<
  string,
  {
    packages: string[];
    files: string[];
 ...
 */
export const STATE_LIBRARIES: Record<string, string[]> = {
 ...
 */
export const STYLING_LIBS: Record<string, string[]> = {
 ...
 * Build tools
 */
export const BUILD_TOOLS: Record<string, { packages: string[]; configs: string[] }> = {
 ...
 */
export const TEST_FRAMEWORKS: Record<string, { packages: string[]; configs: string[] }> = {
 ...
 */
export const DEPENDENCY_CATEGORIES: Record<string, string[]> = {
