...
exports.getCompanyGuidelines = getCompanyGuidelines;
exports.hasCompanyGuidelines = hasCompanyGuidelines;
/**
 * Get company coding guidelines for a specific language
 */
function getCompanyGuidelines(primaryLanguage) {
 ...
 */
function hasCompanyGuidelines(primaryLanguage) {
    const lang = primaryLanguage.toLowerCase();
    return lang === "c++" || lang === "cpp" || lang === "c";
}
//# sourceMappingURL=companyGuidelines.js.map