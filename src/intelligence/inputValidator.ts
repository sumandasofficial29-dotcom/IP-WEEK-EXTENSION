 ...
 */
export function analyzeInputQuality(task: string): InputQualityResult {
  ...
  let enhancedTask: string | undefined;
  if (score < 60) {
...
function generateEnhancedTask(original: string, _issues: InputIssue[]): string {
