...
export interface ArchitectureInfo {
  ...
  build: { bundler?: string; transpiler?: string };
}
...
export class EnhancedTechStackDetector {
  ...
  private detectBuildTools(): { bundler?: string; transpiler?: string } {
    const result: { bundler?: string; transpiler?: string } = {};
  ...
  private walkFiles(callback: (filePath: string) => void, maxDepth: number = 4, dir?: string, depth: number = 0): void {
